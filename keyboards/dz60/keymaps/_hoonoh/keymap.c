...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_64_ansi(
    ...
    KC_TRNS,            RGB_MOD,  RGB_RMOD, RGB_SAI,  RGB_SAD,  KC_TRNS,  KC_TRNS,  KC_INS,   KC_HOME,  KC_PGUP,  KC_TRNS,  KC_TRNS,            KC_TRNS,
    MO(2),              RGB_SPI,  RGB_SPD,  RGB_VAI,  RGB_VAD,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_END,   KC_PGDN,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
